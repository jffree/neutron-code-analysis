...
1. 在 *neutron/extensions* 文件夹下创建一个模块
...
#### `get_resources` 方法实例（[availability_zone extension](https://github.com/openstack/neutron/blob/stable/newton/neutron/extensions/availability_zone.py)）：
